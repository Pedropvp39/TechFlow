...
--
-- Host: localhost:3307
-- Tempo de geração: 25/09/2026 às 13:34
...
(2, NULL, 4, '2026-09-21 14:08:58', 'finalizado'),
(3, NULL, 9, '2026-08-31 11:49:46', 'finalizado'),
(4, NULL, 9, '2026-09-02 11:36:29', 'finalizado'),
(5, NULL, 9, '2026-09-23 11:05:47', 'finalizado'),
(6, NULL, 29, '2026-09-14 13:38:12', 'ativo'),
(7, NULL, 9, '2026-09-25 11:27:36', 'ativo'),
(8, NULL, 4, '2026-09-25 11:29:25', 'ativo');
...
(227, 2, 2, 1, 2199.00, '2026-09-21 14:08:47', 0),
(232, 5, 3, 1, 349.00, '2026-09-23 11:05:42', 0);
...
(14, 'PCs Gamer', 'Produtos da categoria PCs Gamer', '');
...
(26, 4, 2, 'GeForce RTX 4060', 'Placas de vídeo', 2199.00, 1, 'Pago', 0, '2026-09-21 14:08:58', 'Administrador', 'admin@techflow.com', '', '72725301', 'Quadra', '3', 'Brasília', 'DF'),
(27, 9, 3, 'SSD NVMe 1TB', 'Armazenamento', 349.00, 1, 'Pago', 0, '2026-09-23 11:05:47', 'pedro henrique lopes', 'ph305099@gmail.com', '(99) 98452-5003', '72725331', 'Veredas', '1', 'Brasilia', 'DF');
...
(1, 'AMD Ryzen 5 5600', 'Processadores', 899.00, 'Versão com clock aprimorado e cooler box incluso.', 'prod_1789396820_2273.png', 1, '2026-08-19 12:35:04'),
(2, 'GeForce RTX 4060', 'Placas de vídeo', 2199.00, 'Excelente desempenho para jogos em Full HD e 2K com ray tracing.', 'prod_1789396833_4914.png', 0, '2026-08-19 12:35:04'),
(3, 'SSD NVMe 1TB', 'Armazenamento', 349.00, 'Mais velocidade de boot e carregamento de jogos e programas.', 'prod_1789394997_2116.png', 0, '2026-08-19 12:35:04'),
(4, 'Memória RAM DDR5 32GB', 'Memória RAM', 749.00, 'Kit 2x16GB com mais velocidade e estabilidade para multitarefas.', 'prod_1789733219_6138.jpg', 0, '2026-08-19 12:35:04'),
(5, 'Placa-mãe B650 Gaming', 'Placas-mãe', 1099.00, 'Suporte a DDR5 e PCIe 4.0 para builds modernas e expansíveis.', 'prod_1789733251_8257.jpg', 0, '2026-08-19 12:35:04'),
(6, 'Gabinete Gamer Mid-Tower', 'Gabinetes', 459.00, 'Lateral em vidro temperado e fans RGB para exibir seu setup com estilo.', 'prod_1789733264_1198.jpg', 0, '2026-08-19 12:35:04'),
(7, 'Fonte 750W 80 Plus Gold', 'Fontes', 629.00, 'Fonte modular com alta eficiência e proteção para seus componentes.', 'prod_1789733280_5578.jpg', 0, '2026-08-19 12:35:04'),
(8, 'Water Cooler 240mm', 'Refrigeração', 539.00, 'Refrigeração líquida com iluminação RGB para manter a CPU fria.', 'prod_1789733296_3051.jpg', 0, '2026-08-19 12:35:04'),
(9, 'PC Gamer TechFlow RGB RTX 4060', 'PCs Gamer', 4599.00, 'PC Gamer completo montado e testado com Ryzen 5, RTX 4060, 16GB RAM DDR5 e SSD 1TB.', 'prod_1789733306_4941.jpg', 0, '2026-09-02 12:14:21'),
(10, 'Ryzen 7 5700X', 'PC', 1299.00, 'PC Gamer Completinho E Farmador De Aura', 'prod_1789733325_9380.jpg', 0, '2026-08-19 14:38:14'),
(11, 'Ryzen 7 7800X3D', 'Processadores', 2399.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789734141_2359.jpg', 0, '2026-09-02 12:18:47'),
(12, 'Core i5 14400F', 'Processadores', 1199.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789733675_4683.jpg', 0, '2026-09-02 12:18:47'),
(13, 'Core i7 14700K', 'Processadores', 2499.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789733718_4739.jpg', 0, '2026-09-02 12:18:47'),
(14, 'GeForce RTX 4060 Ti', 'Placas de vídeo', 2699.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789733729_3889.jpg', 0, '2026-09-02 12:18:47'),
(15, 'GeForce RTX 4070', 'Placas de vídeo', 3999.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789733739_8384.jpg', 0, '2026-09-02 12:18:47'),
(16, 'Radeon RX 7600', 'Placas de vídeo', 2299.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789733769_8137.jpg', 0, '2026-09-02 12:18:47'),
(17, 'GeForce RTX 4080 Super', 'Placas de vídeo', 6999.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789733782_9620.jpg', 0, '2026-09-02 12:18:47'),
(18, 'Memória DDR4 16GB', 'Memória RAM', 299.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789733796_8317.jpg', 0, '2026-09-02 12:18:47'),
(19, 'Memória DDR5 16GB', 'Memória RAM', 399.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789733807_3613.jpg', 0, '2026-09-02 12:18:47'),
(20, 'Kit RAM DDR5 64GB', 'Memória RAM', 1299.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789733817_2427.jpg', 0, '2026-09-02 12:18:47'),
(21, 'Memória RGB 32GB', 'Memória RAM', 849.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789733852_1919.jpg', 0, '2026-09-02 12:18:47'),
(22, 'SSD NVMe 500GB', 'Armazenamento', 229.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789991728_1687.jpg', 0, '2026-09-02 12:18:47'),
(23, 'SSD NVMe 2TB', 'Armazenamento', 699.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789991744_2975.jpg', 0, '2026-09-02 12:18:47'),
(24, 'HD 2TB Sata', 'Armazenamento', 429.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789992938_2029.jpg', 0, '2026-09-02 12:18:47'),
(25, 'SSD Sata 1TB', 'Armazenamento', 389.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789991795_6633.jpg', 0, '2026-09-02 12:18:47'),
(26, 'Placa-mãe B550M', 'Placas-mãe', 699.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789991829_3972.jpg', 0, '2026-09-02 12:18:47'),
(27, 'Placa-mãe X670 Gaming', 'Placas-mãe', 1899.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789991850_2462.jpg', 0, '2026-09-02 12:18:47'),
(28, 'Placa-mãe H610M', 'Placas-mãe', 499.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789991870_6734.jpg', 0, '2026-09-02 12:18:47'),
(29, 'Placa-mãe Z790 Wi-Fi', 'Placas-mãe', 2199.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789991889_3064.jpg', 0, '2026-09-02 12:18:47'),
(30, 'Gabinete Compacto Airflow', 'Gabinetes', 329.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789992198_7564.jpg', 0, '2026-09-02 12:18:47'),
(31, 'Gabinete RGB Glass', 'Gabinetes', 579.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789992244_2296.jpg', 1, '2026-09-02 12:18:47'),
(32, 'Gabinete Full Tower', 'Gabinetes', 899.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789992276_9276.jpg', 0, '2026-09-02 12:18:47'),
(33, 'Gabinete Mesh Branco', 'Gabinetes', 649.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789992289_8650.jpg', 0, '2026-09-02 12:18:47'),
(34, 'Fonte 550W 80 Plus', 'Fontes', 399.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789992301_7689.jpg', 0, '2026-09-02 12:18:47'),
(35, 'Fonte 850W Modular', 'Fontes', 899.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789992317_2514.jpg', 0, '2026-09-02 12:18:47'),
(36, 'Fonte 1000W Gold', 'Fontes', 1199.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789992330_6274.jpg', 0, '2026-09-02 12:18:47'),
(37, 'Fonte 650W Bronze', 'Fontes', 479.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789992380_8980.jpg', 0, '2026-09-02 12:18:47'),
(38, 'Air Cooler 120mm', 'Refrigeração', 159.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789992895_3393.jpg', 0, '2026-09-02 12:18:47'),
(39, 'Water Cooler 120mm', 'Refrigeração', 299.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789993037_5674.jpg', 0, '2026-09-02 12:18:47'),
(40, 'Water Cooler 360mm', 'Refrigeração', 799.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789993051_8291.jpg', 0, '2026-09-02 12:18:47'),
(41, 'Kit 3 Fans RGB', 'Refrigeração', 219.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789992816_9342.jpg', 0, '2026-09-02 12:18:47'),
(42, 'PC Gamer Ryzen 5', 'PCs Gamer', 3299.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789992797_6722.jpg', 0, '2026-09-02 12:18:47'),
(43, 'PC Gamer RTX 4060 Ti', 'PCs Gamer', 5499.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789992854_5808.jpg', 0, '2026-09-02 12:18:47'),
(44, 'PC Gamer Ryzen 7', 'PCs Gamer', 6499.00, 'Componente selecionado para montar um computador rápido e confiável.', 'prod_1789992871_7157.jpg', 0, '2026-09-02 12:18:47'),
...
(4, 'admin@techflow.com', '1990-01-15', 'Administrador', '$2y$10$YJwGr8oh1nPud/edW2RMuullyQLVHWBl/MgjWBG34/hSBDb8EdcDS', 'admin', 1, 'assets/img/avatars/avatar_4_1787147198.jpg', '99984525003', '2026-08-21 13:08:21', NULL, NULL, NULL, NULL, NULL, NULL, 'ativo'),
...
(29, 'ph3050@gmail.com', '2000-12-30', 'PEDROPVP', '$2y$10$qannvZ5OU/JYY295z1pXluxLmzJV4Xa7jRJfy/h/ewvfVY87zwRRq', 'cliente', 0, NULL, NULL, '2026-09-14 13:37:42', NULL, NULL, NULL, NULL, NULL, NULL, 'ativo'),
(31, 'testando1@gmail.com', '2000-12-15', 'trer', '$2y$10$edI6jme/LeMcDB9nDVt3gOTpxgKTzljph6u1kGI6B.eHzKk1SMqRO', 'cliente', 0, NULL, NULL, '2026-09-21 14:16:01', NULL, NULL, NULL, NULL, NULL, NULL, 'ativo');
