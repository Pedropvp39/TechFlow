...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!csrf_check($_POST['csrf'] ?? null)) {
        ...
        if (!validar_senha_mestre_admin($senhaMaster)) {
            $mensagem = 'ðŸ”’ Senha de confirmação de administrador incorreta! Operação cancelada por segurança. (Chave padrão de segurança: master88)';
            $tipoMensagem = 'error';
        } else {
            switch ($acao) {
                // --- PRODUTOS ---
...
<div class="section">
    <div class="section-head">
        ...
        <div class="admin-master-badge">
            <span>ðŸ”’ Chave de Confirmação Ativa</span>
        </div>
    </div>
    ...
    <div id="tab-usuarios" class="admin-tab-content">
        <div class="panel">
            <div class="panel-head-flex">
                ...
                <button type="button" class="btn btn-sm" onclick="openAddUserModal()">âž• Novo Usuário</button>
            </div>
            <div class="admin-table-responsive">
                <table class="admin-table">
                    <thead>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if (!empty($ped['rua'])): ?>
                                            <br><small style="color:var(--accent-2);">ðŸ“ <?= e($ped['rua']) ?>, nº <?= e($ped['numero']) ?> â” <?= e($ped['cidade']) ?>/<?= e($ped['estado']) ?> (CEP: <?= e($ped['cep']) ?>)</small>
                                        <?php endif; ?>
                                    </td>
    ...
    <div id="tab-categorias" class="admin-tab-content">
        <div class="panel">
            <div class="panel-head-flex">
                ...
                <button type="button" class="btn btn-sm" onclick="document.getElementById('modalAddCategory').classList.remove('hidden')">âž• Nova Categoria</button>
            </div>
            <div class="admin-table-responsive">
                <table class="admin-table">
                    <thead>
                    ...
                    <tbody>
                        <?php foreach ($avaliacoesProdutos as $aval): ?>
                            <tr>
                                ...
                                <td style="max-width:260px;"><?= e($aval['comentario']) ?><?php if (!empty($aval['denuncias_info'])): ?><br><small style="color:var(--danger-text);">Denúncia: <?= e($aval['denuncias_info']) ?></small><?php endif; ?></td>
                                <td><?= e($aval['status']) ?></td>
            ...
            <form method="post" action="<?= e($base) ?>/pages/admin-produtos.php" class="form-grid" enctype="multipart/form-data">
                ...
                <div class="field-master-security" style="grid-column: 1 / -1;">
                    ...
                    <div class="password-wrapper">
                        ...
                        <button type="button" class="toggle-password" data-target="senha_master_add" aria-label="Mostrar/esconder senha">ðŸ‘️</button>
                    </div>
...
<div id="modalEditProduct" class="checkout-message hidden" role="dialog" aria-modal="true">
    <div class="checkout-message-card admin-modal-card">
        <button type="button" class="checkout-close" onclick="closeModal('modalEditProduct')">Ã—</button>
        <h3>âœ️ Editar Produto</h3>
        <form method="post" action="<?= e($base) ?>/pages/admin-produtos.php" class="form-grid" enctype="multipart/form-data">
            <input type="hidden" name="csrf" value="<?= e(csrf_token()) ?>">
            ...
            <div class="field-master-security" style="grid-column: 1 / -1;">
                <label for="edit_prod_master">ðŸ”’ Senha de confirmação do Administrador</label>
...
<div id="modalDeleteProduct" class="checkout-message hidden" role="dialog" aria-modal="true">
    <div class="checkout-message-card">
        <button type="button" class="checkout-close" onclick="closeModal('modalDeleteProduct')">Ã—</button>
        <h3 style="color:var(--danger-text);">Excluir Produto</h3>
...
<div id="modalAddUser" class="checkout-message hidden" role="dialog" aria-modal="true">
    <div class="checkout-message-card admin-modal-card">
        ...
        <h3>âž• Cadastrar Novo Usuário</h3>
        ...
        <form method="post" action="<?= e($base) ?>/pages/admin-produtos.php" class="form-grid">
            ...
            <div class="field-master-security" style="grid-column: 1 / -1;">
                <label for="add_user_master">ðŸ”’ Senha de confirmação do Administrador (Chave Mestre)</label>
...
<div id="modalEditUser" class="checkout-message hidden" role="dialog" aria-modal="true">
    <div class="checkout-message-card admin-modal-card">
        <button type="button" class="checkout-close" onclick="closeModal('modalEditUser')">Ã—</button>
        <h3>âœ️ Editar Usuário</h3>
        <form method="post" action="<?= e($base) ?>/pages/admin-produtos.php" class="form-grid">
            <input type="hidden" name="csrf" value="<?= e(csrf_token()) ?>">
...
<div id="modalDeleteUser" class="checkout-message hidden" role="dialog" aria-modal="true">
    <div class="checkout-message-card">
        <button type="button" class="checkout-close" onclick="closeModal('modalDeleteUser')">Ã—</button>
        <h3 style="color:var(--danger-text);">Excluir Usuário</h3>
...
<div id="modalEditOrder" class="checkout-message hidden" role="dialog" aria-modal="true">
    <div class="checkout-message-card">
        ...
        <form method="post" action="<?= e($base) ?>/pages/admin-produtos.php">
            ...
            <div class="field-master-security" style="margin-bottom: 16px;">
                <label for="edit_ped_master">ðŸ”’ Senha de confirmação do Administrador</label>
...
<div id="modalDeleteOrder" class="checkout-message hidden" role="dialog" aria-modal="true">
    <div class="checkout-message-card">
        <button type="button" class="checkout-close" onclick="closeModal('modalDeleteOrder')">Ã—</button>
        <h3 style="color:var(--danger-text);">🗑️ Excluir Pedido</h3>
        ...
        <form method="post" action="<?= e($base) ?>/pages/admin-produtos.php">
            ...
            <div class="field-master-security" style="margin-bottom: 16px;">
                <label for="del_ped_master">ðŸ”’ Senha de confirmação do Administrador</label>
...
<div id="modalAddCategory" class="checkout-message hidden" role="dialog" aria-modal="true">
    <div class="checkout-message-card">
        <button type="button" class="checkout-close" onclick="closeModal('modalAddCategory')">Ã—</button>
...
<div id="modalEditCategory" class="checkout-message hidden" role="dialog" aria-modal="true">
    <div class="checkout-message-card">
        <button type="button" class="checkout-close" onclick="closeModal('modalEditCategory')">Ã—</button>
        <h3>âœ️ Editar Categoria</h3>
        <form method="post" action="<?= e($base) ?>/pages/admin-produtos.php">
            <input type="hidden" name="csrf" value="<?= e(csrf_token()) ?>">
            ...
            <div class="field-master-security" style="margin-bottom: 16px;">
                <label for="edit_cat_master">ðŸ”’ Senha de confirmação do Administrador</label>
...
<div id="modalDeleteCategory" class="checkout-message hidden" role="dialog" aria-modal="true">
    <div class="checkout-message-card">
        <button type="button" class="checkout-close" onclick="closeModal('modalDeleteCategory')">Ã—</button>
        <h3 style="color:var(--danger-text);">🗑️ Excluir Categoria</h3>
        ...
        <form method="post" action="<?= e($base) ?>/pages/admin-produtos.php">
            ...
            <div class="field-master-security" style="margin-bottom: 16px;">
                <label for="del_cat_master">ðŸ”’ Senha de confirmação do Administrador</label>
