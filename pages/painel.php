...
<div class="section">
    <div class="section-head" style="margin-bottom: 20px;">
        ...
        <div style="text-align: right;">
            <span style="display: inline-block; padding: 6px 14px; background: rgba(34, 197, 94, 0.2); border: 1px solid rgba(197, 34, 34, 0.44); border-radius: 20px; font-weight: 700; color: #6e6a69;">
    ...
    <div style="background: var(--testo2); border: 1px solid var(--border); border-radius: 12px; padding: 14px 18px; margin-bottom: 20px; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 10px;">
        ...
        <form method="post" action="<?= e($panelAction) ?>" style="display: flex; gap: 8px; align-items: center;">
            ...
            <input type="password" name="senha_master" required minlength="4" placeholder="Chave atual" style="padding: 6px 10px; font-size: 0.82rem; border-radius: 6px;  border: 1px solid var(--border); color: #fff;">
            <input type="password" name="nova_chave_mestre" required minlength="4" placeholder="Nova chave mestre" style="padding: 6px 10px; font-size: 0.82rem; border-radius: 6px;  border: 1px solid var(--border); color: #fff;">
        ...
        <div class="panel" style="border-left: 4px solid #06b5d4dc;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 14px; margin-top: 16px;">
                <div style=" padding: 14px; border-radius: 8px; border: 1px solid rgba(6,182,212,0.3);">
                    <small style="color: #33d1e2;">Versão PHP</small>
                    <div style="font-size: 1.2rem; font-weight: 700; color: #817878;"><?= PHP_VERSION ?></div>
                </div>
                <div style=" padding: 14px; border-radius: 8px; border: 1px solid  rgba(6, 181, 212, 0.59);">
                    <small style="color: #33d1e2;">Servidor Web</small>
                    <div style="font-size: 0.92rem; font-weight: 700; color:  #817878"><?= e($_SERVER['SERVER_SOFTWARE'] ?? 'Apache') ?></div>
                </div>
                <div style=" padding: 14px; border-radius: 8px; border: 1px solid rgba(6, 181, 212, 0.59);">
                    <small style="color: #33d1e2;">Status Banco MySQL</small>
                    <div style="font-size: 1.1rem; font-weight: 700; color: #817878">🟢 Ativo e Conectado</div>
                </div>
                <div style=" padding: 14px; border-radius: 8px; border: 1px solid  rgba(6, 181, 212, 0.59);">
                    <small style="color: #33d1e2;">Sessão PHP</small>
                    <div style="font-size: 0.85rem; font-weight: 600; color:  #817878; overflow: hidden; text-overflow: ellipsis;"><?= e(session_id()) ?></div>
                </div>
            </div>
            ...
            <div style="margin-top: 24px;">
                <form method="post" action="<?= e($panelAction) ?>">
                    ...
                    <div style="display:flex; gap:10px; align-items:center; flex-wrap:wrap;">
                        <input type="password" name="senha_master" required placeholder="🔒 Sua Chave Mestre Desenvolvedor" style="padding: 8px 12px; border-radius: 6px; border: 1px solid var(--border); color:#fff;">
                        ...
                        <?php foreach ($chamadosSuporte as $cham): ?>
                            <tr>
                                ...
                                <td>
                                        ...
                                        <input type="text" name="resposta" placeholder="Digite a resposta do suporte..." required style="padding:4px 8px; font-size:0.8rem; border-radius:4px;  border:1px solid var(--border); color:#fff;">
                                        <input type="password" name="senha_master" placeholder="🔑 Sua Chave Mestre" required style="padding:4px 8px; font-size:0.8rem; border-radius:4px; border:1px solid var(--border); color:#fff;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="post" action="<?= e($panelAction) ?>" style="display:flex; gap:6px; align-items:center;">
                                        ...
                                        <input type="password" name="senha_master" placeholder="🔑 Sua Chave Mestre" required style="padding:4px 8px; font-size:0.8rem; border-radius:4px; border:1px solid var(--border); color:#fff; width:130px;">
        ...
        <div class="panel" style="border-left: 4px solid #10b981;">
            ...
            <div style="background: rgba(16,185,129,0.1); border: 1px solid rgba(16,185,129,0.3); border-radius: 12px; padding: 16px; margin-top: 16px;">
                ...
                <form method="post" action="<?= e($panelAction) ?>" class="manager-coupon-form">
                    ...
                    <input type="text" name="codigo_cupom" placeholder="Ex: PROMO15" required style="padding:8px 12px; border-radius:6px;  border:1px solid var(--border); color:#fff; text-transform:uppercase;">
                    <input type="number" name="desconto_percentual" placeholder="Desconto %" min="1" max="90" required style="padding:8px 12px; border-radius:6px;  border:1px solid var(--border); color:#fff; width:120px;">
                    <input type="password" name="senha_master" placeholder="🔑 Sua Chave Mestre" required style="padding:8px 12px; border-radius:6px; border:1px solid var(--border); color:#fff;">
                                ...
                                <td>
                                    <form method="post" action="<?= e($panelAction) ?>" style="display:flex; flex-direction:column; gap:6px;">
                                        ...
                                        <div style="display:flex; gap:6px;">
                                            ...
                                            <input type="text" name="codigo_rastreio" placeholder="Ex: TF123456789BR" value="<?= e($logisticaAtual['codigo_rastreio'] ?? '') ?>" required style="padding:4px 8px; font-size:0.8rem; border-radius:4px;  border:1px solid var(--border); color:#fff; width:140px;">
                                            <select name="status_expedicao" style="padding:4px 8px; font-size:0.8rem; border-radius:4px; background:gray; border:1px solid var(--border); color:#black;">
    ...
    <div class="checkout-message-card">
        ...
        <form method="post" action="<?= e($panelAction) ?>">
            ...
            <div class="field" style="margin-bottom: 14px;">
                ...
                <select id="edit_order_status" name="status" required style="width: 100%; padding: 10px; border-radius: 8px; color: #fff; border: 1px solid var(--border);">
